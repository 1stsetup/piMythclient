...
pi: LDFLAGS+=-L$(SDKSTAGE)/opt/vc/lib/ -L/lib -L/usr/lib/arm-linux-gnueabihf/ -lGLESv2 -lEGL -lopenmaxil -lbcm_host -lvcos -lvchiq_arm -L/opt/vc/src/hello_pi/libs/ilclient -L/opt/vc/src/hello_pi/libs/vgfont -lvgfont
pi: INCLUDES+=-I$(SDKSTAGE)/opt/vc/include/ -I$(SDKSTAGE)/opt/vc/include/interface/vcos/pthreads -I./ -I/opt/vc/src/hello_pi/libs/ilclient -I/opt/vc/src/hello_pi/libs/vgfont -I/include -I/opt/vc/include/interface/vmcs_host/linux/
pi: all
